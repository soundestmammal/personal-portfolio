        ...
        <SpotlightContainer>
            <SpotlightContent>
                ...
                <SpotlightIconRow>
                    ...
                    <li><a href="https://drive.google.com/file/d/1v1H5M2oFyfNGuYn7yXYDGYvazPhNI82L/view?usp=sharing" target="_blank" style={{ fontSize: '1em', border: '1px solid #AAAAAA', color: '#AAAAAA', padding: '3px 6px', textDecoration: 'none'}}>Resume</a></li>
                </SpotlightIconRow>
            </SpotlightContent>
