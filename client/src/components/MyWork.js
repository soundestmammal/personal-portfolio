            ...
            <div className="portfolio_2">
                ...
                <div className="card" style={{ backgroundImage: "url(https://imgix.datadoghq.com/img/careers/careers_pattern_OS.png?auto=format)" }}>
                    <div className="card-content">
                            ...
                            <div className="button-container">
                                <div className="project-button" onClick={() => openTabInNewTab("https://github.com/soundestmammal/dynamic-vehicle-modeling/blob/master/Longitudinal_Vehicle_Model.ipynb")}>View Project</div>
                                <div className="project-button" onClick={() => openTabInNewTab("https://github.com/soundestmammal/dynamic-vehicle-modeling/blob/master/Longitudinal_Vehicle_Model.ipynb")}>View Code</div>
                            </div>
                    </div>
                </div>                
